...
<b>※本演習環境で用意したリソースの上限値が定義されているため、この演習内容を同時に実施するのは受講者10人まで(正確に表現すると、コンピュートノードの追加が20台まで)という制約があります。受講者の人数がこれを超える場合、インストラクターによるデモまたは説明のみとなりますので、予めご了承ください。</b>
